...
import (
	...
	"github.com/previousnext/terraform-provider-k8s/rbac/v1/role/rule/apigroups"
	"github.com/previousnext/terraform-provider-k8s/rbac/v1/role/rule/resources"
	"github.com/previousnext/terraform-provider-k8s/rbac/v1/role/rule/verbs"
)

const (
	// FieldRule is used to identify the rule field.
	FieldRule = "rule"
