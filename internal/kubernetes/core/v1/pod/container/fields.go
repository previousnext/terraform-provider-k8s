...
import (
	...
	"github.com/previousnext/terraform-provider-k8s/internal/kubernetes/core/v1/pod/container/args"
	"github.com/previousnext/terraform-provider-k8s/internal/kubernetes/core/v1/pod/container/command"
	"github.com/previousnext/terraform-provider-k8s/internal/kubernetes/core/v1/pod/container/envvar"
	"github.com/previousnext/terraform-provider-k8s/internal/kubernetes/core/v1/pod/container/lifecycle"
	"github.com/previousnext/terraform-provider-k8s/internal/kubernetes/core/v1/pod/container/mount"
	"github.com/previousnext/terraform-provider-k8s/internal/kubernetes/core/v1/pod/container/port"
	"github.com/previousnext/terraform-provider-k8s/internal/kubernetes/core/v1/pod/container/probe"
	"github.com/previousnext/terraform-provider-k8s/internal/kubernetes/core/v1/pod/container/resource"
)
